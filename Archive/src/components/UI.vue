        ...
        <div class="cent">
          <div class="container-l">
            ...
            <div id="scroller-1" class="content-chat">
              <p id="test" class="description" v-for="item in chat.log" :key="item">
                {{ item }}
              </p>
            ...
            <input v-model="message" placeholder="What do you say?" v-on:keyup.enter="sendMessage(message)" />
          </div>
